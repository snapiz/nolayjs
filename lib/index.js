...
exports.default = function (options) {
  ...
  options.modules = [_acl2.default, _user2.default].concat(_toConsumableArray(options.modules), [_sequelize4.default]);

  options.modules.forEach(function (middleware) {
    ...
    return app.get('sequelize').sync(options.sequelize.sync).then(function () {
      var schema = (0, _relaySequelize.createSequelizeGraphqlSchema)(app.get('sequelize'), {
        queries: function queries(nodeInterface, resolver) {
          return options.modules.filter(function (m) {
